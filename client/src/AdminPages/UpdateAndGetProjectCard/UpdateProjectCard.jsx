    ...
    useEffect(() => {
        const getSingleCard = async () => {
            try {
                ...
                setTitle(title);
                setText(text);
                setImageUrl(`${process.env.REACT_APP_API}/api/v1/project-cards/card-photo/${_id}
    ...
    const handleUpdate = async () => {
        try {
            ...
            if (data.success) {
                ...
                navigate('/dashboard-admin/get-project-card'); // Redirect after successful update
            } else {
        ...
        try {
            ...
            if (confirmed) {
                ...
                if (data.success) {
                    ...
                    navigate('/dashboard-admin/get-project-card'); // Redirect after successful deletion
                } else {
