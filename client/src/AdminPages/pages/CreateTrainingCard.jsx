...
const  CreateTrainingCard = () => {
    ...
    const handleCreate = async (e) => {
        ...
        try {
            ...
            const { data } = axios.post(`${process.env.REACT_APP_API}/api/v1/training-cards/create-card`, productData)
            if (data?.success) {
                alert(data?.message)
            } else {
    ...
    return (
        <Layout title={' CreateTrainingCard Card'}>
            <div className='fluid-container m-3 p-3'>
                <div className='row'>
                    ...
                    <div className='col-lg-9 col-md-8 col-sm-8'>
                        <h1 style={{ fontSize: '4rem' }}> Create Training Cards</h1>
