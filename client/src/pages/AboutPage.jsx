  ...
  return (
    <Layout>
      ...
      <div style={{ paddingBottom: '250px' }} className="fluid-container about-section1">
        <div className="row">
          <div className="col-lg-6 col-md-12 col-sm-12 section-4-container-row image-about1">
            {/* <img width={'90%'} height={'90%'} src={''} alt="ok" className="about-image" /> */}
          </div>
          <div className="col-lg-6 col-md-12 section-4-container-row col-sm-12">
      ...
      <div className="container section-4-container-about">
        <h1 style={{ fontSize: '3.9rem' }}>Why Choose Us</h1>
